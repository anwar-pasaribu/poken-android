...
public class Tracking {
    ...
    public static final String TRACK_CONTACT_WA = "contact-wa";
    public static final String TRACK_CONTACT_IG = "contact-ig";
    public static final String TRACK_CONTACT_FB = "contact-fb";
