...
public class WalletPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public CharSequence getPageTitle(int position) {
        ...
        switch (position) {
            case 0:
                return mContext.getString(R.string.subtitle_wallet_history);
            case 1:
                return mContext.getString(R.string.subtitle_wallet_tupup);
            case 2:
                return mContext.getString(R.string.subtitle_wallet_withdrawal);
