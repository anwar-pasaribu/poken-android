package id.unware.poken.ui.store.summary.view.adapter;
...
import id.unware.poken.ui.store.summary.presenter.IStoreSummaryPresenter;
...
public class StoreSummaryLatestProductAdapter extends RecyclerView.Adapter<StoreSummaryLatestProductAdapter.ViewHolder> {

    private final List<Product> mValues;
    private final IStoreSummaryPresenter mListener;
    private final GlideRequest<Drawable> requestBuilder;

    public StoreSummaryLatestProductAdapter(List<Product> items, IStoreSummaryPresenter listener,
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_store_summary_latest_product, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tvDiscountAmount.setText(StringUtils.getFormattedDiscountPercent(discountAmount));
