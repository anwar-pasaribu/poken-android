...
public class PickupInteractor implements VolleyResultListener {
    ...
    void beginRequestPickup(View parentView, PojoPickupHistory pickupData) {
    ...
    void reverseGeocoding(double lat, double lon) {
     ...
     * @since V49 - NEW MVP
     */
    void reverseGeocodingHttp(View parentView, double lat, double lon) {
